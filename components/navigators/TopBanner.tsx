import { cn, prefix } from "@/libs/util";
...
const contactInfo = {
  phone: {
    href: "#",
    iconSrc: `${prefix}08/Phone-Icon-2.png`,
    iconAlt: "Phone Icon",
    text: "+234 148 06 219",
    iconWidth: 15,
    iconHeight: 15,
  ...
  email: {
    href: "#",
    iconSrc: `${prefix}08/Mail-Icon-1.png`,
    iconAlt: "Mail Icon",
  ...
  support: {
    href: "#",
    iconSrc: `${prefix}08/Support-Icon-top-header.png`,
  ...
  trace: {
    href: "#",
    iconSrc: `${prefix}08/Tracking-Icon.png`,
