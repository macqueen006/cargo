function PrevArrow(props: { onClick?: () => void }) {
    ...
    return (
      <div
        onClick={onClick}
        className="arrow-left z-[6] group cursor-pointer opacity-100 top-full left-0  bg-transparent absolute h-[8rem] w-[6.6rem] flex items-center text-dark-color translate-x-[4rem] -translate-y-[8rem] lg:translate-x-[12.5rem] lg:-translate-y-[8rem]"
      >
        <svg
